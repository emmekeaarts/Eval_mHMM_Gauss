...
model_selection_2st <- data.frame(true_m = 2,
                                  n = settings4[c(selected, selected_p2, selected_p4), 1], 
                                  n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                                  n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                                  KL_div = settings4[c(selected, selected_p2, selected_p4), 4],
...
mean_abs_bias_emiss <- data.frame(true_m = 2,
                                  n = settings4[c(selected, selected_p2, selected_p4), 1], 
                                  n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                                  n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                                  KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
mean_rel_bias_emiss <- data.frame(true_m = 2,
                                  n = settings4[c(selected, selected_p2, selected_p4), 1], 
                                  n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                                  n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                                  KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  diff <- mapply('-', group_out_2st_emiss_mean[[sc]]$median, means_true[[sc]], SIMPLIFY = FALSE)
...
bias_emiss_SD <- data.frame(true_m = 2,
                            n = settings4[c(selected, selected_p2, selected_p4), 1], 
                            n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                            n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                            KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  diff <- mapply('-', group_out_2st_emiss_sd[[sc]]$median, 1, SIMPLIFY = FALSE)
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  proxy_labelsw[[sc]] <- lapply(group_out_2st_emiss_mean[[sc]]$median, apply, 1, rmse)
}

label_switch <- data.frame(true_m = 2,
                           n = settings4[c(selected, selected_p2, selected_p4), 1], 
                           n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                           n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                           KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
group_out_2st_emiss_mean[[65]]$median

hist(unlist(proxy_labelsw[[128]]), breaks = 20)
group_out_2st_emiss_mean[[128]]$median

hist(unlist(proxy_labelsw[[61]]), breaks = 20)
group_out_2st_emiss_mean[[61]]$median
...
mean_bias_gamma <- data.frame(true_m = 2,
                              n = settings4[c(selected, selected_p2, selected_p4), 1], 
                              n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                              n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                              KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
mean_rel_bias_gamma <- data.frame(true_m = 2,
                                  n = settings4[c(selected, selected_p2, selected_p4), 1], 
                                  n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                                  n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                                  KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  mean_bias_gamma[sc, 6] <- mean(apply(group_out_2st_gamma_prob[[sc]]$median[,c(1, 4)], 2, median) - diag_gamma)
  mean_bias_gamma[sc, 7] <- mean(apply(group_out_2st_gamma_prob[[sc]]$median[,-c(1, 4)], 2, median) - off_diag_gamma)
  mean_rel_bias_gamma[sc, 6] <-  median((apply(group_out_2st_gamma_prob[[sc]]$median[,c(1, 4)], 2, median) - diag_gamma) / diag_gamma)
  mean_rel_bias_gamma[sc, 7] <-  median((apply(group_out_2st_gamma_prob[[sc]]$median[,-c(1, 4)], 2, median) - off_diag_gamma) / off_diag_gamma)
}
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  SD_emp_se[sc, 6] <- mean(sqrt(unlist(lapply(group_out_2st_emiss_sd[[sc]]$median, apply, 2, var))))
}
...
### Gamma, prob scale ####
emp_se_gamma <- data.frame(true_m = 2,
                           n = settings4[c(selected, selected_p2, selected_p4), 1], 
                           n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                           n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                           KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  emp_se_gamma[sc, 6] <- mean(sqrt(apply(group_out_2st_gamma_prob[[sc]]$median[,c(1, 4)], 2, var)))
  emp_se_gamma[sc, 7] <-  mean(sqrt(apply(group_out_2st_gamma_prob[[sc]]$median[,-c(1, 4)], 2, var)))
}
...
ggplot(data = gg_emp_se_gamma, mapping = aes(x = n_t, y = value, group = interaction(as.factor(n), as.factor(diag)), color = as.factor(n))) +
  ...
  geom_point() + 
  geom_line(aes(linetype = as.factor(diag))) +
  ylab("Gamma emperical SE diagonal") +
  facet_grid(rows = vars(as.factor(KL_div)), cols = vars(as.factor(n_dep))) +
  scale_color_discrete(name = "Number of\nsubjects") +
  scale_linetype_manual(name = "Transition type", 
                        values = c(1, 3),
...
## Coverage ####
### Emission distribution - MEAN ####
Coverage_emiss <- data.frame(true_m = 2,
                             n = settings4[c(selected, selected_p2, selected_p4), 1], 
                             n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                             n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                             KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  lower_90 <- lapply(mapply('<', group_out_2st_emiss_mean[[sc]]$quant_5, means_true[[sc]], SIMPLIFY = FALSE), "*", 1)
  upper_90 <- lapply(mapply('>', group_out_2st_emiss_mean[[sc]]$quant_95, means_true[[sc]], SIMPLIFY = FALSE), "*", 1)
  Coverage_emiss[sc, 6] <- sum(mapply("*", lower_90, upper_90)) / (n_sim * Coverage_emiss$n_dep[sc] * true_m) * 100
  lower_95 <- lapply(mapply('<', group_out_2st_emiss_mean[[sc]]$quant_2.5, means_true[[sc]], SIMPLIFY = FALSE), "*", 1)
  upper_95 <- lapply(mapply('>', group_out_2st_emiss_mean[[sc]]$quant_97.5, means_true[[sc]], SIMPLIFY = FALSE), "*", 1)
...
### Emission distribution - SD ####
Coverage_emiss_SD <- data.frame(true_m = 2,
                                n = settings4[c(selected, selected_p2, selected_p4), 1], 
                                n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                                n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                                KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  lower_90 <- lapply(mapply('<', group_out_2st_emiss_sd[[sc]]$quant_5, 1, SIMPLIFY = FALSE), "*", 1)
  upper_90 <- lapply(mapply('>', group_out_2st_emiss_sd[[sc]]$quant_95,1, SIMPLIFY = FALSE), "*", 1)
  Coverage_emiss_SD[sc, 6] <- sum(mapply("*", lower_90, upper_90)) / (n_sim * Coverage_emiss$n_dep[sc] * true_m) * 100
  lower_95 <- lapply(mapply('<', group_out_2st_emiss_sd[[sc]]$quant_2.5, 1, SIMPLIFY = FALSE), "*", 1)
  upper_95 <- lapply(mapply('>', group_out_2st_emiss_sd[[sc]]$quant_97.5, 1, SIMPLIFY = FALSE), "*", 1)
...
emission_performance_2st <- data.frame(true_m = 2,
                                       n = settings4[c(selected, selected_p2, selected_p4), 1], 
                                       n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                                       n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                                       KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
Coverage_gamma <- data.frame(true_m = 2,
                             n = settings4[c(selected, selected_p2, selected_p4), 1], 
                             n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                             n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                             KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
for(sc in 1:length(c(selected, selected_p2, selected_p4))){
  lower_90_diag <- (group_out_2st_gamma_prob[[sc]]$quant_5[,c(1, 4)] < matrix(diag_gamma, nrow = n_sim, ncol = true_m, byrow = TRUE)) * 1
  upper_90_diag <-  (group_out_2st_gamma_prob[[sc]]$quant_95[,c(1, 4)] > matrix(diag_gamma, nrow = n_sim, ncol = true_m, byrow = TRUE)) * 1
  lower_90_off <-  (group_out_2st_gamma_prob[[sc]]$quant_5[,-c(1, 4)] < matrix(off_diag_gamma, nrow = n_sim, ncol = true_m*(true_m-1), byrow = TRUE)) * 1
  upper_90_off <-  (group_out_2st_gamma_prob[[sc]]$quant_95[,-c(1, 4)] > matrix(off_diag_gamma, nrow = n_sim, ncol = true_m*(true_m-1), byrow = TRUE)) * 1
  ...
  lower_95_diag <-  (group_out_2st_gamma_prob[[sc]]$quant_2.5[,c(1, 4)] < matrix(diag_gamma, nrow = n_sim, ncol = true_m, byrow = TRUE)) * 1
  upper_95_diag <- (group_out_2st_gamma_prob[[sc]]$quant_95[,c(1, 4)] > matrix(diag_gamma, nrow = n_sim, ncol = true_m, byrow = TRUE)) * 1
  lower_95_off <-  (group_out_2st_gamma_prob[[sc]]$quant_2.5[,-c(1, 4)] < matrix(off_diag_gamma, nrow = n_sim, ncol = true_m*(true_m-1), byrow = TRUE)) * 1
  upper_95_off <- (group_out_2st_gamma_prob[[sc]]$quant_95[,-c(1, 4)] > matrix(off_diag_gamma, nrow = n_sim, ncol = true_m*(true_m-1), byrow = TRUE)) * 1
...
gamma_performance_2st <- data.frame(true_m = 2,
                                    n = settings4[c(selected, selected_p2, selected_p4), 1], 
                                    n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                                    n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                                    KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
state_decoding <- data.frame(true_m = 2,
                             n = settings4[c(selected, selected_p2, selected_p4), 1], 
                             n_t = settings4[c(selected, selected_p2, selected_p4), 2],
                             n_dep = settings4[c(selected, selected_p2, selected_p4), 3], 
                             KL_div = settings4[c(selected, selected_p2, selected_p4), 4], 
...
Result_table_2st <- list(model_selection_2st = model_selection_2st,
                         emission_performance_2st = emission_performance_2st,
                         gamma_performance_2st = gamma_performance_2st,
                         state_decoding_2st = state_decoding)

saveRDS(Result_table_2st, file = "result_tables/Result_table_2st.RDS")
