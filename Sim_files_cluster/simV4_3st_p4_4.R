...
manual_prior_gamma <- vector(mode = 'list', max_m)

manual_prior_gamma[[2]] <- prior_gamma(m = 2, gamma_mu0 = list(prob_to_int(matrix(c(0.7, 0.3), nrow = 1)),
                                                               prob_to_int(matrix(c(0.3, 0.7), nrow = 1)))) 
manual_prior_gamma[[3]] <- prior_gamma(m = 3, gamma_mu0 = list(prob_to_int(matrix(c(0.6, 0.2, 0.2), nrow = 1)),
                                                               prob_to_int(matrix(c(0.2, 0.6, 0.2), nrow = 1)),
                                                               prob_to_int(matrix(c(0.2, 0.2, 0.6), nrow = 1)))) 
manual_prior_gamma[[4]] <- prior_gamma(m = 4, gamma_mu0 = list(prob_to_int(matrix(c(0.7, 0.1, 0.1, 0.1), nrow = 1)),
                                                               prob_to_int(matrix(c(0.1, 0.7, 0.1, 0.1), nrow = 1)),
                                                               prob_to_int(matrix(c(0.1, 0.1, 0.7, 0.1), nrow = 1)),
                                                               prob_to_int(matrix(c(0.1, 0.1, 0.1, 0.7), nrow = 1)))) 

for(i in 1:max_m){
  m <- i
  gen      <- list(m = m, n_dep = n_dep)
  emiss_K0 <- rep(list(1), n_dep)
  emiss_V  <-  rep(list(rep(.1^2, m)), n_dep)
  emiss_nu <- rep(list(1), n_dep)
  emiss_a0 <- rep(list(rep(3, m)), n_dep)
...
subj_out_3st <- list(subj_gamma_prob  = 
...
true_state_probs <- cbind(rep(1:n, each = n_t), matrix(,nrow = n_t*n, ncol = n_sim))
colnames(true_state_probs) <- c("ID", paste0("sim", 1:n_sim))
  ...
  for(i in 1:max_m){
    if(i == 1){
      ...
      fit_out <- mHMM(s_data = data_cont[[s]]$obs,
                      ...
                      start_val = c(list(gamma_start[[i]]), emiss_start[[i]][[s]]),
                      emiss_hyp_prior = manual_prior_emiss[[i]][[s]],
                      gamma_hyp_prior = manual_prior_gamma[[i]],
                      mcmc = list(J = J, burn_in = burn_in))
    }
    ...
    if(i == true_m){
      ...
      foo_states <- vit_mHMM(fit_out, data_cont[[s]]$obs, return_state_prob = TRUE)
      inferred_states[, (1+s)] <- foo_states[,2]
      true_state_probs[, (1+s)] <- foo_states[cbind(1:dim(foo_states)[1], (true_states[,(s+1)] + 2))]
      
      # save group level transition probability outcomes, probability scale 
      group_out_3st$trans_prob$mean[s,] <- apply(fit_out$gamma_prob_bar[((burn_in + 1): J),], 2, mean)
      group_out_3st$trans_prob$var[s,] <- apply(fit_out$gamma_prob_bar[((burn_in + 1): J),], 2, var)
      group_out_3st$trans_prob$mode[s,] <- apply(fit_out$gamma_prob_bar[((burn_in + 1): J),], 2, Mode)
      group_out_3st$trans_prob$median[s,] <- apply(fit_out$gamma_prob_bar[((burn_in + 1): J),], 2, median)
      quantiles <- apply(fit_out$gamma_prob_bar[((burn_in + 1): J),], 2, quantile, 
                         probs = c(0.025, 0.05, 0.25, 0.75, 0.95, 0.975))
      group_out_3st$trans_prob$quant_2.5[s,] <- quantiles[1,]
      group_out_3st$trans_prob$quant_5[s,] <- quantiles[2,] 
      group_out_3st$trans_prob$quant_25[s,] <- quantiles[3,]  
      group_out_3st$trans_prob$quant_75[s,] <- quantiles[4,]
      group_out_3st$trans_prob$quant_95[s,] <-  quantiles[5,]
      group_out_3st$trans_prob$quant_97.5[s,] <- quantiles[6,]
      
      # save group level transition probability outcomes, logit scale
      group_out_3st$trans_interc$mean[s,] <- apply(fit_out$gamma_int_bar[((burn_in + 1): J),], 2, mean)
      group_out_3st$trans_interc$var[s,] <- apply(fit_out$gamma_int_bar[((burn_in + 1): J),], 2, var)
      group_out_3st$trans_interc$mode[s,] <-  apply(fit_out$gamma_int_bar[((burn_in + 1): J),], 2, Mode)
      group_out_3st$trans_interc$median[s,] <- apply(fit_out$gamma_int_bar[((burn_in + 1): J),], 2, median)
      quantiles <- apply(fit_out$gamma_int_bar[((burn_in + 1): J),], 2, quantile, 
                         probs = c(0.025, 0.05, 0.25, 0.75, 0.95, 0.975))
      group_out_3st$trans_interc$quant_2.5[s,] <- quantiles[1,]
      group_out_3st$trans_interc$quant_5[s,] <- quantiles[2,]
      group_out_3st$trans_interc$quant_25[s,] <- quantiles[3,]  
      group_out_3st$trans_interc$quant_75[s,] <- quantiles[4,]
      group_out_3st$trans_interc$quant_95[s,] <-  quantiles[5,]
      group_out_3st$trans_interc$quant_97.5[s,] <- quantiles[6,]
      
      # save group level between subject variance on transition probability outcomes, logit scale
      group_out_3st$trans_betw_subj$mean[s,] <- apply(fit_out$gamma_V_int_bar[((burn_in + 1): J),], 2, mean)
      group_out_3st$trans_betw_subj$var[s,] <- apply(fit_out$gamma_V_int_bar[((burn_in + 1): J),], 2, var)
      group_out_3st$trans_betw_subj$mode[s,] <- apply(fit_out$gamma_V_int_bar[((burn_in + 1): J),], 2, Mode)
      group_out_3st$trans_betw_subj$median[s,] <- apply(fit_out$gamma_V_int_bar[((burn_in + 1): J),], 2, median)
      quantiles <- apply(fit_out$gamma_V_int_bar[((burn_in + 1): J),], 2, quantile, 
                         probs = c(0.025, 0.05, 0.25, 0.75, 0.95, 0.975))
      group_out_3st$trans_betw_subj$quant_2.5[s,] <- quantiles[1,]
      group_out_3st$trans_betw_subj$quant_5[s,] <- quantiles[2,]
      group_out_3st$trans_betw_subj$quant_25[s,] <- quantiles[3,]  
      group_out_3st$trans_betw_subj$quant_75[s,] <- quantiles[4,]
      group_out_3st$trans_betw_subj$quant_95[s,] <-  quantiles[5,]
      group_out_3st$trans_betw_subj$quant_97.5[s,] <- quantiles[6,]
      ...
      for(q in 1:n_dep){
        ...
        group_out_3st$emiss_mean$mean[[q]][s,] <- apply(fit_out$emiss_mu_bar[[q]][((burn_in + 1): J),], 2, mean) 
        group_out_3st$emiss_mean$var[[q]][s,] <- apply(fit_out$emiss_mu_bar[[q]][((burn_in + 1): J),], 2, var) 
        group_out_3st$emiss_mean$mode[[q]][s,] <- apply(fit_out$emiss_mu_bar[[q]][((burn_in + 1): J),], 2, Mode) 
        group_out_3st$emiss_mean$median[[q]][s,] <- apply(fit_out$emiss_mu_bar[[q]][((burn_in + 1): J),], 2, median) 
        quantiles <- apply(fit_out$emiss_mu_bar[[q]][((burn_in + 1): J),], 2, quantile, 
                           probs = c(0.025, 0.05, 0.25, 0.75, 0.95, 0.975))
        group_out_3st$emiss_mean$quant_2.5[[q]][s,] <- quantiles[1,]
        group_out_3st$emiss_mean$quant_5[[q]][s,] <- quantiles[2,]
        group_out_3st$emiss_mean$quant_25[[q]][s,] <- quantiles[3,]  
        group_out_3st$emiss_mean$quant_75[[q]][s,] <- quantiles[4,]
        group_out_3st$emiss_mean$quant_95[[q]][s,] <-  quantiles[5,]
        group_out_3st$emiss_mean$quant_97.5[[q]][s,] <- quantiles[6,]
        
        # variable and state dependent emission SD's (fixed over subjects)
        group_out_3st$emiss_sd$mean[[q]][s,] <- apply(fit_out$emiss_sd_bar[[q]][((burn_in + 1): J),], 2, mean) 
        group_out_3st$emiss_sd$var[[q]][s,] <- apply(fit_out$emiss_sd_bar[[q]][((burn_in + 1): J),], 2, var) 
        group_out_3st$emiss_sd$mode[[q]][s,] <- apply(fit_out$emiss_sd_bar[[q]][((burn_in + 1): J),], 2, Mode) 
        group_out_3st$emiss_sd$median[[q]][s,] <- apply(fit_out$emiss_sd_bar[[q]][((burn_in + 1): J),], 2, median) 
        quantiles <- apply(fit_out$emiss_sd_bar[[q]][((burn_in + 1): J),], 2, quantile, 
                           probs = c(0.025, 0.05, 0.25, 0.75, 0.95, 0.975))
        group_out_3st$emiss_sd$quant_2.5[[q]][s,] <- quantiles[1,]
        group_out_3st$emiss_sd$quant_5[[q]][s,] <- quantiles[2,]
        group_out_3st$emiss_sd$quant_25[[q]][s,] <- quantiles[3,]  
        group_out_3st$emiss_sd$quant_75[[q]][s,] <- quantiles[4,]
        group_out_3st$emiss_sd$quant_95[[q]][s,] <-  quantiles[5,]
        group_out_3st$emiss_sd$quant_97.5[[q]][s,] <- quantiles[6,]
        
        # variable and state dependent emission between subject variance on means
        group_out_3st$emiss_betw_subj$mean[[q]][s,] <- apply(fit_out$emiss_varmu_bar[[q]][((burn_in + 1): J),], 2, mean) 
        group_out_3st$emiss_betw_subj$var[[q]][s,] <- apply(fit_out$emiss_varmu_bar[[q]][((burn_in + 1): J),], 2, var) 
        group_out_3st$emiss_betw_subj$mode[[q]][s,] <- apply(fit_out$emiss_varmu_bar[[q]][((burn_in + 1): J),], 2, Mode) 
        group_out_3st$emiss_betw_subj$median[[q]][s,] <- apply(fit_out$emiss_varmu_bar[[q]][((burn_in + 1): J),], 2, median) 
        quantiles <- apply(fit_out$emiss_varmu_bar[[q]][((burn_in + 1): J),], 2, quantile, 
                           probs = c(0.025, 0.05, 0.25, 0.75, 0.95, 0.975))
        group_out_3st$emiss_betw_subj$quant_2.5[[q]][s,] <- quantiles[1,]
        group_out_3st$emiss_betw_subj$quant_5[[q]][s,] <- quantiles[2,]
        group_out_3st$emiss_betw_subj$quant_25[[q]][s,] <- quantiles[3,]  
        group_out_3st$emiss_betw_subj$quant_75[[q]][s,] <- quantiles[4,]
        group_out_3st$emiss_betw_subj$quant_95[[q]][s,] <-  quantiles[5,]
        group_out_3st$emiss_betw_subj$quant_97.5[[q]][s,] <- quantiles[6,]
      }
      # save selection of subject level parameters
      subj_out_3st$subj_gamma_prob$mean[[s]] <- t(sapply(sapply(fit_out$PD_subj,"[[", 1, simplify = FALSE), apply, 2, mean))
      subj_out_3st$subj_gamma_prob$median[[s]] <- t(sapply(sapply(fit_out$PD_subj,"[[", 1, simplify = FALSE), apply, 2, median))
      subj_out_3st$subj_gamma_prob$var[[s]] <- t(sapply(sapply(fit_out$PD_subj,"[[", 1, simplify = FALSE), apply, 2, var))
      subj_out_3st$subj_gamma_prob$quant_2.5[[s]] <- t(sapply(sapply(fit_out$PD_subj,"[[", 1, simplify = FALSE), apply, 2, quantile, prob = c(0.025)))
      subj_out_3st$subj_gamma_prob$quant_97.5[[s]] <- t(sapply(sapply(fit_out$PD_subj,"[[", 1, simplify = FALSE), apply, 2, quantile, prob = c(0.975)))
      
      subj_out_3st$subj_gamma_int$mean[[s]] <- t(sapply(fit_out$gamma_int_subj, apply, 2, mean))
      subj_out_3st$subj_gamma_int$median[[s]] <- t(sapply(fit_out$gamma_int_subj, apply, 2, median))
      subj_out_3st$subj_gamma_int$var[[s]] <- t(sapply(fit_out$gamma_int_subj, apply, 2, var))
      subj_out_3st$subj_gamma_int$quant_2.5[[s]] <- t(sapply(fit_out$gamma_int_subj, apply, 2, quantile, prob = c(0.025)))
      subj_out_3st$subj_gamma_int$quant_97.5[[s]] <- t(sapply(fit_out$gamma_int_subj, apply, 2, quantile, prob = c(0.975)))
      
      subj_out_3st$subj_emiss$mean[[s]]  <- t(sapply(sapply(fit_out$PD_subj,"[[", 3, simplify = FALSE), apply, 2, mean))[,1:(true_m*n_dep)]
      subj_out_3st$subj_emiss$median[[s]]  <- t(sapply(sapply(fit_out$PD_subj,"[[", 3, simplify = FALSE), apply, 2, median))[,1:(true_m*n_dep)]
      subj_out_3st$subj_emiss$var[[s]]  <-t(sapply(sapply(fit_out$PD_subj,"[[", 3, simplify = FALSE), apply, 2, var))[,1:(true_m*n_dep)]
      subj_out_3st$subj_emiss$quant_2.5[[s]]  <-t(sapply(sapply(fit_out$PD_subj,"[[", 3, simplify = FALSE), apply, 2, quantile, prob = c(0.025)))[,1:(true_m*n_dep)]
      subj_out_3st$subj_emiss$quant_97.5[[s]]  <-t(sapply(sapply(fit_out$PD_subj,"[[", 3, simplify = FALSE), apply, 2, quantile, prob = c(0.975)))[,1:(true_m*n_dep)]
    }
  }
}

out_4 = list(selection_out = selection_out, 
             gamma_full = gamma_full,
             emiss_mean_full = emiss_mean_full,
             PD_full = PD_full,
             group_out_3st = group_out_3st, 
             subj_out_3st = subj_out_3st, 
             input = input, 
             subj_par = subj_par, 
...
saveRDS(out_4, file = paste0("out_V4/", out_file, "_4.rds"))
