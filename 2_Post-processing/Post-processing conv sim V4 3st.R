...
group_out_3st_emiss_mean0 <- vector("list", length = length(c(files, files_p2_1, files_p4_1)))
group_out_3st_emiss_mean1 <- vector("list", length = length(c(files, files_p2_1, files_p4_1)))
group_out_3st_emiss_mean2 <- vector("list", length = length(c(files, files_p2_1, files_p4_1)))
...
for(sc in 1:length(files)){
  ...
  group_out_3st_emiss_mean0[[sc]]$median  <- out0[[sc]]$group_out_3st$emiss_mean$median
  group_out_3st_emiss_mean1[[sc]]$median  <- out1[[sc]]$group_out_3st_conv1$emiss_mean$median
  group_out_3st_emiss_mean2[[sc]]$median  <- out2[[sc]]$group_out_3st_conv2$emiss_mean$median
...
for(sc in 1:length(files_p2_1)){
  ...
  group_out_3st_emiss_mean0[[sc + l_files]]$median     <-  Map(rbind,out0_p2_1[[sc]]$group_out_3st$emiss_mean$median, 
                                                                     out0_p2_2[[sc]]$group_out_3st$emiss_mean$median)
  group_out_3st_emiss_mean1[[sc + l_files]]$median  <- Map(rbind, out1_p2_1[[sc]]$group_out_3st_conv1$emiss_mean$median,
                                                                  out1_p2_2[[sc]]$group_out_3st_conv1$emiss_mean$median)
  group_out_3st_emiss_mean2[[sc + l_files]]$median  <- Map(rbind, out2_p2_1[[sc]]$group_out_3st_conv2$emiss_mean$median,
                                                                  out2_p2_2[[sc]]$group_out_3st_conv2$emiss_mean$median)
...
for(sc in 1:length(files_p4_1)){
  ...
  group_out_3st_emiss_mean0[[sc + l_files_p2]]$median     <-  Map(rbind,out0_p4_1[[sc]]$group_out_3st$emiss_mean$median, 
                                                               out0_p4_2[[sc]]$group_out_3st$emiss_mean$median,
                                                               out0_p4_3[[sc]]$group_out_3st$emiss_mean$median,
                                                               out0_p4_4[[sc]]$group_out_3st$emiss_mean$median)
  group_out_3st_emiss_mean1[[sc + l_files_p2]]$median  <- Map(rbind, out1_p4_1[[sc]]$group_out_3st_conv1$emiss_mean$median,
                                                           out1_p4_2[[sc]]$group_out_3st_conv1$emiss_mean$median,
                                                           out1_p4_3[[sc]]$group_out_3st_conv1$emiss_mean$median,
                                                           out1_p4_4[[sc]]$group_out_3st_conv1$emiss_mean$median)
  group_out_3st_emiss_mean2[[sc + l_files_p2]]$median  <- Map(rbind, out2_p4_1[[sc]]$group_out_3st_conv2$emiss_mean$median,
                                                           out2_p4_2[[sc]]$group_out_3st_conv2$emiss_mean$median,
                                                           out2_p4_3[[sc]]$group_out_3st_conv2$emiss_mean$median,
                                                           out2_p4_4[[sc]]$group_out_3st_conv2$emiss_mean$median)
...
extracted_convergence_3st <- list(means_true0 = means_true0,
                                  ...
                                  group_out_3st_emiss_mean0 = group_out_3st_emiss_mean0,
                                  group_out_3st_emiss_mean1 = group_out_3st_emiss_mean1,
                                  group_out_3st_emiss_mean2 = group_out_3st_emiss_mean2,
...
# RUN 1, FULL RUN
Label_switch_proxy_3st0p1 <- data.frame(sim_iteration = 1:n_sim,
                                     true_m = true_m,
...
for(sc in selected){
  Label_switch_proxy_3st0p1[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean0[[sc]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st0p1)



Label_switch_proxy_3st0p2 <- data.frame(sim_iteration = 1:n_sim,
                                        true_m = true_m,
...
for(sc in 1:length(selected_p2)){
  Label_switch_proxy_3st0p2[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean0[[sc + l_files]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st0p2)



Label_switch_proxy_3st0p4 <- data.frame(sim_iteration = 1:n_sim,
                                        true_m = true_m,
...
for(sc in 1:length(c(selected_p4))){
  Label_switch_proxy_3st0p4[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean0[[sc + l_files_p2]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st0p4)



# RUN 2, only 4 runs (for p1 and p2, by accident 6 runs for p4)
Label_switch_proxy_3st1p1 <- data.frame(sim_iteration = 1:4,
                                        true_m = true_m,
...
for(sc in selected){
  Label_switch_proxy_3st1p1[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean1[[sc]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st1p1)



Label_switch_proxy_3st1p2 <- data.frame(sim_iteration = 1:4,
                                        true_m = true_m,
...
for(sc in 1:length(selected_p2)){
  Label_switch_proxy_3st1p2[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean1[[sc + l_files]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st1p2)



Label_switch_proxy_3st1p4 <- data.frame(sim_iteration = 1:6,
                                        true_m = true_m,
                                        n = rep(settings4[c(selected_p4), 1], times = 6  * settings4[c(selected_p4), 3]), 
                                        n_t = rep(settings4[c(selected_p4), 2], times = 6  * settings4[c(selected_p4), 3]),
                                        n_dep = rep(settings4[c(selected_p4), 3], times = 6  * settings4[c(selected_p4), 3]),
                                        KL_div = rep(settings4[c(selected_p4), 4], times = 6  * settings4[c(selected_p4), 3]), 
                                        dep = rep(sequence(settings4[c(selected_p4), 3], 1, 1), each = 6),
                                        RMSE = NA)


it <- 6  * settings4[c(selected_p4), 3]
cumsum_it <-  c(0,cumsum(6  * settings4[c(selected_p4), 3]))

for(sc in 1:length(c(selected_p4))){
  Label_switch_proxy_3st1p4[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean1[[sc + l_files_p2]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st1p4)

# RUN 3, only 4 runs (for p1 and p2, by accident 6 runs for p4)
Label_switch_proxy_3st2p1 <- data.frame(sim_iteration = 1:4,
                                        true_m = true_m,
                                        n = rep(settings4[c(selected), 1], times = 4  * settings4[c(selected), 3]), 
                                        n_t = rep(settings4[c(selected), 2], times = 4  * settings4[c(selected), 3]),
                                        n_dep = rep(settings4[c(selected), 3], times = 4  * settings4[c(selected), 3]),
...
for(sc in selected){
  Label_switch_proxy_3st2p1[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean2[[sc]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st2p1)



Label_switch_proxy_3st2p2 <- data.frame(sim_iteration = 1:4,
                                        true_m = true_m,
                                        n = rep(settings4[c(selected_p2), 1], times = 4  * settings4[c(selected_p2), 3]), 
                                        n_t = rep(settings4[c(selected_p2), 2], times = 4  * settings4[c(selected_p2), 3]),
                                        n_dep = rep(settings4[c(selected_p2), 3], times = 4  * settings4[c(selected_p2), 3]),
...
for(sc in 1:length(selected_p2)){
  Label_switch_proxy_3st2p2[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean2[[sc + l_files]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st2p2)



Label_switch_proxy_3st2p4 <- data.frame(sim_iteration = 1:6,
                                        true_m = true_m,
                                        n = rep(settings4[c(selected_p4), 1], times = 6  * settings4[c(selected_p4), 3]), 
                                        n_t = rep(settings4[c(selected_p4), 2], times = 6  * settings4[c(selected_p4), 3]),
                                        n_dep = rep(settings4[c(selected_p4), 3], times = 6  * settings4[c(selected_p4), 3]),
...
for(sc in 1:length(c(selected_p4))){
  Label_switch_proxy_3st2p4[(1 + cumsum_it[sc]) : (it[sc] + cumsum_it[sc]),8] <- unlist(lapply(group_out_3st_emiss_mean2[[sc + l_files_p2]]$median, apply, 1, rmse))
}

View(Label_switch_proxy_3st2p4)



### aggregating over dependent variables within a simrun, convergence run 1 ####

aggr_Label_switch_proxy_3st0p1 <- aggregate(Label_switch_proxy_3st0p1, by = list(Label_switch_proxy_3st0p1$sim_iteration, 
                                                                                 Label_switch_proxy_3st0p1$KL_div,
                                                                                 Label_switch_proxy_3st0p1$n_dep, 
                                                                                 Label_switch_proxy_3st0p1$n_t, 
                                                                                 Label_switch_proxy_3st0p1$n), FUN = mean)

aggr_Label_switch_proxy_3st0p2 <- aggregate(Label_switch_proxy_3st0p2, by = list(Label_switch_proxy_3st0p2$sim_iteration, 
                                                                                 Label_switch_proxy_3st0p2$KL_div,
                                                                                 Label_switch_proxy_3st0p2$n_dep, 
                                                                                 Label_switch_proxy_3st0p2$n_t, 
                                                                                 Label_switch_proxy_3st0p2$n), FUN = mean)

aggr_Label_switch_proxy_3st0p4 <- aggregate(Label_switch_proxy_3st0p4, by = list(Label_switch_proxy_3st0p4$sim_iteration, 
                                                                                 Label_switch_proxy_3st0p4$KL_div,
                                                                                 Label_switch_proxy_3st0p4$n_dep, 
                                                                                 Label_switch_proxy_3st0p4$n_t, 
                                                                                 Label_switch_proxy_3st0p4$n), FUN = mean)

#### Making correct sub selection 
aggr_Label_switch_proxy_3st0p1_select <- aggr_Label_switch_proxy_3st0p1[aggr_Label_switch_proxy_3st0p1$sim_iteration %in% c(20, 40, 60, 80),]
aggr_Label_switch_proxy_3st0p2_select <- aggr_Label_switch_proxy_3st0p2[aggr_Label_switch_proxy_3st0p2$sim_iteration %in% c(20, 40, (50 + 20), (50 + 40)),]
aggr_Label_switch_proxy_3st0p4_select <- aggr_Label_switch_proxy_3st0p4[aggr_Label_switch_proxy_3st0p4$sim_iteration %in% c(20, (25+20), (50 + 20), (75 + 20)),]


### aggregating over dependent variables within a simrun, convergence run 2 ####

aggr_Label_switch_proxy_3st1p1 <- aggregate(Label_switch_proxy_3st1p1, by = list(Label_switch_proxy_3st1p1$sim_iteration, 
                                                                                 Label_switch_proxy_3st1p1$KL_div,
                                                                                 Label_switch_proxy_3st1p1$n_dep, 
                                                                                 Label_switch_proxy_3st1p1$n_t, 
                                                                                 Label_switch_proxy_3st1p1$n), FUN = mean)

aggr_Label_switch_proxy_3st1p2 <- aggregate(Label_switch_proxy_3st1p2, by = list(Label_switch_proxy_3st1p2$sim_iteration, 
                                                                                 Label_switch_proxy_3st1p2$KL_div,
                                                                                 Label_switch_proxy_3st1p2$n_dep, 
                                                                                 Label_switch_proxy_3st1p2$n_t, 
                                                                                 Label_switch_proxy_3st1p2$n), FUN = mean)

aggr_Label_switch_proxy_3st1p4 <- aggregate(Label_switch_proxy_3st1p4, by = list(Label_switch_proxy_3st1p4$sim_iteration, 
                                                                                 Label_switch_proxy_3st1p4$KL_div,
                                                                                 Label_switch_proxy_3st1p4$n_dep, 
                                                                                 Label_switch_proxy_3st1p4$n_t, 
                                                                                 Label_switch_proxy_3st1p4$n), FUN = mean)

### aggregating over dependent variables within a simrun, convergence run 3 ####
aggr_Label_switch_proxy_3st2p1 <- aggregate(Label_switch_proxy_3st2p1, by = list(Label_switch_proxy_3st2p1$sim_iteration, 
                                                                                 Label_switch_proxy_3st2p1$KL_div,
                                                                                 Label_switch_proxy_3st2p1$n_dep, 
                                                                                 Label_switch_proxy_3st2p1$n_t, 
                                                                                 Label_switch_proxy_3st2p1$n), FUN = mean)

aggr_Label_switch_proxy_3st2p2 <- aggregate(Label_switch_proxy_3st2p2, by = list(Label_switch_proxy_3st2p2$sim_iteration, 
                                                                                 Label_switch_proxy_3st2p2$KL_div,
                                                                                 Label_switch_proxy_3st2p2$n_dep, 
                                                                                 Label_switch_proxy_3st2p2$n_t, 
                                                                                 Label_switch_proxy_3st2p2$n), FUN = mean)

aggr_Label_switch_proxy_3st2p4 <- aggregate(Label_switch_proxy_3st2p4, by = list(Label_switch_proxy_3st2p4$sim_iteration, 
                                                                                 Label_switch_proxy_3st2p4$KL_div,
                                                                                 Label_switch_proxy_3st2p4$n_dep, 
                                                                                 Label_switch_proxy_3st2p4$n_t, 
                                                                                 Label_switch_proxy_3st2p4$n), FUN = mean)

# Creating label switching indicator

aggr_Label_switch_proxy_3st0p1_select$present <- (aggr_Label_switch_proxy_3st0p1_select$RMSE < 0.20 ) * 1
aggr_Label_switch_proxy_3st0p2_select$present <- (aggr_Label_switch_proxy_3st0p2_select$RMSE < 0.20 ) * 1
aggr_Label_switch_proxy_3st0p4_select$present <- (aggr_Label_switch_proxy_3st0p4_select$RMSE < 0.20 ) * 1

aggr_Label_switch_proxy_3st1p1$present1 <- (aggr_Label_switch_proxy_3st1p1$RMSE < 0.20 ) * 1
aggr_Label_switch_proxy_3st1p2$present1 <- (aggr_Label_switch_proxy_3st1p2$RMSE < 0.20 ) * 1
aggr_Label_switch_proxy_3st1p4$present1 <- (aggr_Label_switch_proxy_3st1p4$RMSE < 0.20 ) * 1

aggr_Label_switch_proxy_3st2p1$present2 <- (aggr_Label_switch_proxy_3st2p1$RMSE < 0.20 ) * 1
aggr_Label_switch_proxy_3st2p2$present2 <- (aggr_Label_switch_proxy_3st2p2$RMSE < 0.20 ) * 1
aggr_Label_switch_proxy_3st2p4$present2 <- (aggr_Label_switch_proxy_3st2p4$RMSE < 0.20 ) * 1


aggr_Label_switch_proxy_3st1p1$present0 <- aggr_Label_switch_proxy_3st0p1_select$present
aggr_Label_switch_proxy_3st1p2$present0 <- aggr_Label_switch_proxy_3st0p2_select$present 

aggr_Label_switch_proxy_3st1p4_subs <- aggr_Label_switch_proxy_3st1p4[aggr_Label_switch_proxy_3st1p4$sim_iteration %in% c(1,2,3,5),]
aggr_Label_switch_proxy_3st1p4_subs$present0 <- aggr_Label_switch_proxy_3st0p4_select$present 


aggr_Label_switch_proxy_3st1p1$present2 <- aggr_Label_switch_proxy_3st2p1$present2
aggr_Label_switch_proxy_3st1p2$present2 <- aggr_Label_switch_proxy_3st2p2$present2 

aggr_Label_switch_proxy_3st2p4_subs <- aggr_Label_switch_proxy_3st2p4[aggr_Label_switch_proxy_3st2p4$sim_iteration %in% c(1,2,3,5),]
aggr_Label_switch_proxy_3st1p4_subs$present2 <- aggr_Label_switch_proxy_3st2p4_subs$present2


aggr_Label_switch_proxy_3st1p1$presentSUM <- aggr_Label_switch_proxy_3st1p1$present0 + 
                                              aggr_Label_switch_proxy_3st1p1$present1 +
                                              aggr_Label_switch_proxy_3st1p1$present2

aggr_Label_switch_proxy_3st1p1$no_chain <- (aggr_Label_switch_proxy_3st1p1$presentSUM != 0) * 1
aggr2_Label_switch_proxy_3st1p1 <- aggregate(aggr_Label_switch_proxy_3st1p1, by = list(aggr_Label_switch_proxy_3st1p1$KL_div,
                                                                                       aggr_Label_switch_proxy_3st1p1$n_dep, 
                                                                                       aggr_Label_switch_proxy_3st1p1$n_t, 
                                                                                       aggr_Label_switch_proxy_3st1p1$n), FUN = sum)

table(aggr_Label_switch_proxy_3st1p1$presentSUM)

aggr_Label_switch_proxy_3st1p2$presentSUM <- aggr_Label_switch_proxy_3st1p2$present0 + 
  aggr_Label_switch_proxy_3st1p2$present1 +
  aggr_Label_switch_proxy_3st1p2$present2

aggr_Label_switch_proxy_3st1p2$no_chain <- (aggr_Label_switch_proxy_3st1p2$presentSUM != 0) * 1
aggr2_Label_switch_proxy_3st1p2 <- aggregate(aggr_Label_switch_proxy_3st1p2, by = list(aggr_Label_switch_proxy_3st1p2$KL_div,
                                                                                            aggr_Label_switch_proxy_3st1p2$n_dep, 
                                                                                            aggr_Label_switch_proxy_3st1p2$n_t, 
                                                                                            aggr_Label_switch_proxy_3st1p2$n), FUN = sum)


table(aggr_Label_switch_proxy_3st1p2$presentSUM)

aggr_Label_switch_proxy_3st1p4_subs$presentSUM <- aggr_Label_switch_proxy_3st1p4_subs$present0 + 
  aggr_Label_switch_proxy_3st1p4_subs$present1 +
  aggr_Label_switch_proxy_3st1p4_subs$present2

aggr_Label_switch_proxy_3st1p4_subs$sim_iteration[aggr_Label_switch_proxy_3st1p4_subs$sim_iteration == 5] <- 4

table(aggr_Label_switch_proxy_3st1p4_subs$presentSUM)

aggr_Label_switch_proxy_3st1p4_subs$no_chain <- (aggr_Label_switch_proxy_3st1p4_subs$presentSUM != 0) * 1
aggr2_Label_switch_proxy_3st1p4_subs <- aggregate(aggr_Label_switch_proxy_3st1p4_subs, by = list(aggr_Label_switch_proxy_3st1p4_subs$KL_div,
                                                                                                 aggr_Label_switch_proxy_3st1p4_subs$n_dep, 
                                                                                                 aggr_Label_switch_proxy_3st1p4_subs$n_t, 
                                                                                                 aggr_Label_switch_proxy_3st1p4_subs$n), FUN = sum)
...
sim_it <- 1
n_sim <- 4
Convergence_gamma_3st_p1 <- data.frame(sim_rep = rep(1:4, each = true_m * true_m),
                                    true_m = true_m,
                                    ...
                                    GR_stat = NA,
                                    valid_runs = NA) 
Convergence_gamma_3st_p2 <- data.frame(sim_rep = rep(1:4, each = true_m * true_m),
                                       true_m = true_m,
                                       ...
                                       GR_stat = NA,
                                       valid_runs = NA) 
Convergence_gamma_3st_p4 <- data.frame(sim_rep = rep(1:4, each = true_m * true_m),
                                       true_m = true_m,
...
for(sc in 1:length(selected)){
  for(sim_it in 1:4){
    ...
    valid <- 4- aggr2_Label_switch_proxy_3st1p1$no_chain[which(aggr2_Label_switch_proxy_3st1p1$Group.4 == Convergence_gamma_3st_p1$n[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p1$Group.3 == Convergence_gamma_3st_p1$n_t[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p1$Group.2 == Convergence_gamma_3st_p1$n_dep[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p1$Group.1 == Convergence_gamma_3st_p1$KL_div[ind])]
    Convergence_gamma_3st_p1[ind: 
                               ((sim_it) * true_m * true_m + spacer), 10] <- valid
    
    sum_present <- aggr_Label_switch_proxy_3st1p1$presentSUM[which(aggr_Label_switch_proxy_3st1p1$sim_iteration == sim_it &
                                                                     aggr_Label_switch_proxy_3st1p1$n == Convergence_gamma_3st_p1$n[ind] &
                                                                     aggr_Label_switch_proxy_3st1p1$n_t == Convergence_gamma_3st_p1$n_t[ind] &
                                                                     aggr_Label_switch_proxy_3st1p1$n_dep == Convergence_gamma_3st_p1$n_dep[ind] &
                                                                     aggr_Label_switch_proxy_3st1p1$KL_div == Convergence_gamma_3st_p1$KL_div[ind])]
    if(sum_present == 0){
      Convergence_gamma_3st_p1[ind:
                                 ((sim_it) * true_m * true_m + spacer) ,9] <- Gelman_rubin_trans(data1 = gamma_full_conv0[[sc]][[sim_it]],  
                                                                                                 ...
                                                                                                 burn_in = burn_in, 
                                                                                                 n_chain = 3)
    } # else if(sum_present == 1) {
    #  if(aggr_Label_switch_proxy_3st1p1$present0[which(aggr_Label_switch_proxy_3st1p1$sim_iteration == sim_it &
    #                                                     aggr_Label_switch_proxy_3st1p1$n == Convergence_gamma_3st_p1$n[ind] &
    #                                                     aggr_Label_switch_proxy_3st1p1$n_t == Convergence_gamma_3st_p1$n_t[ind] &
    #                                                     aggr_Label_switch_proxy_3st1p1$n_dep == Convergence_gamma_3st_p1$n_dep[ind] &
    #                                                     aggr_Label_switch_proxy_3st1p1$KL_div == Convergence_gamma_3st_p1$KL_div[ind])] == 1){
    #    Convergence_gamma_3st_p1[ind:
    #                               ((sim_it) * true_m * true_m + spacer) ,9] <- Gelman_rubin_trans(data1 = NULL,  
    #                                                                                               data2 = gamma_full_conv1[[sc]][[sim_it]],  
    #                                                                                               data3 = gamma_full_conv2[[sc]][[sim_it]], 
    #                                                                                               m = true_m, 
    #                                                                                               J = J, 
    #                                                                                               burn_in = burn_in, 
    #                                                                                               n_chain = 2)
    #  } else if(aggr_Label_switch_proxy_3st1p1$present1[which(aggr_Label_switch_proxy_3st1p1$sim_iteration == sim_it &
    #                                                          aggr_Label_switch_proxy_3st1p1$n == Convergence_gamma_3st_p1$n[ind] &
    #                                                          aggr_Label_switch_proxy_3st1p1$n_t == Convergence_gamma_3st_p1$n_t[ind] &
    #                                                          aggr_Label_switch_proxy_3st1p1$n_dep == Convergence_gamma_3st_p1$n_dep[ind] &
    #                                                          aggr_Label_switch_proxy_3st1p1$KL_div == Convergence_gamma_3st_p1$KL_div[ind])] == 1){
    ...
    #                                                                                               burn_in = burn_in, 
    #                                                                                               n_chain = 2)
    #  } else if(aggr_Label_switch_proxy_3st1p1$present2[which(aggr_Label_switch_proxy_3st1p1$sim_iteration == sim_it &
    #                                                          aggr_Label_switch_proxy_3st1p1$n == Convergence_gamma_3st_p1$n[ind] &
    #                                                          aggr_Label_switch_proxy_3st1p1$n_t == Convergence_gamma_3st_p1$n_t[ind] &
    #                                                          aggr_Label_switch_proxy_3st1p1$n_dep == Convergence_gamma_3st_p1$n_dep[ind] &
    #                                                          aggr_Label_switch_proxy_3st1p1$KL_div == Convergence_gamma_3st_p1$KL_div[ind])] == 1){
...
for(sc in 1:length(selected_p2)){
  for(sim_it in 1:4){
    ...
    valid <- 4- aggr2_Label_switch_proxy_3st1p2$no_chain[which(aggr2_Label_switch_proxy_3st1p2$Group.4 == Convergence_gamma_3st_p2$n[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p2$Group.3 == Convergence_gamma_3st_p2$n_t[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p2$Group.2 == Convergence_gamma_3st_p2$n_dep[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p2$Group.1 == Convergence_gamma_3st_p2$KL_div[ind])]
    Convergence_gamma_3st_p2[ind: 
                               ((sim_it) * true_m * true_m + spacer), 10] <- valid
    
    sum_present <- aggr_Label_switch_proxy_3st1p2$presentSUM[which(aggr_Label_switch_proxy_3st1p2$sim_iteration == sim_it &
                                                                     aggr_Label_switch_proxy_3st1p2$n == Convergence_gamma_3st_p2$n[ind] &
                                                                     aggr_Label_switch_proxy_3st1p2$n_t == Convergence_gamma_3st_p2$n_t[ind] &
                                                                     aggr_Label_switch_proxy_3st1p2$n_dep == Convergence_gamma_3st_p2$n_dep[ind] &
                                                                     aggr_Label_switch_proxy_3st1p2$KL_div == Convergence_gamma_3st_p2$KL_div[ind])]
    if(sum_present == 0){
      Convergence_gamma_3st_p2[ind:
      ...
      # if(aggr_Label_switch_proxy_3st1p2$present0[which(aggr_Label_switch_proxy_3st1p2$sim_iteration == sim_it &
      #                                                  aggr_Label_switch_proxy_3st1p2$n == Convergence_gamma_3st_p2$n[ind] &
      #                                                 aggr_Label_switch_proxy_3st1p2$n_t == Convergence_gamma_3st_p2$n_t[ind] &
      #                                                 aggr_Label_switch_proxy_3st1p2$n_dep == Convergence_gamma_3st_p2$n_dep[ind] &
      #                                                 aggr_Label_switch_proxy_3st1p2$KL_div == Convergence_gamma_3st_p2$KL_div[ind])] == 1){
      #  Convergence_gamma_3st_p2[ind:
      #                             ((sim_it) * true_m * true_m + spacer) ,9] <- Gelman_rubin_trans(data1 = NULL,  
      #                                                                                             data2 = gamma_full_conv1[[sc + l_files]][[sim_it]],  
      #                                                                                             data3 = gamma_full_conv2[[sc + l_files]][[sim_it]], 
      ...
      #                                                                                             burn_in = burn_in, 
      #                                                                                             n_chain = 2)
      #} else if(aggr_Label_switch_proxy_3st1p2$present1[which(aggr_Label_switch_proxy_3st1p2$sim_iteration == sim_it &
      #                                                        aggr_Label_switch_proxy_3st1p2$n == Convergence_gamma_3st_p2$n[ind] &
      #                                                        aggr_Label_switch_proxy_3st1p2$n_t == Convergence_gamma_3st_p2$n_t[ind] &
      #                                                        aggr_Label_switch_proxy_3st1p2$n_dep == Convergence_gamma_3st_p2$n_dep[ind] &
      #                                                        aggr_Label_switch_proxy_3st1p2$KL_div == Convergence_gamma_3st_p2$KL_div[ind])] == 1){
      ...
      #                                                                                             burn_in = burn_in, 
      #                                                                                             n_chain = 2)
      #} else if(aggr_Label_switch_proxy_3st1p2$present2[which(aggr_Label_switch_proxy_3st1p2$sim_iteration == sim_it &
      #                                                        aggr_Label_switch_proxy_3st1p2$n == Convergence_gamma_3st_p2$n[ind] &
      #                                                        aggr_Label_switch_proxy_3st1p2$n_t == Convergence_gamma_3st_p2$n_t[ind] &
      #                                                        aggr_Label_switch_proxy_3st1p2$n_dep == Convergence_gamma_3st_p2$n_dep[ind] &
      #                                                        aggr_Label_switch_proxy_3st1p2$KL_div == Convergence_gamma_3st_p2$KL_div[ind])] == 1){
...
for(sc in 1:length(selected_p4)){
  for(sim_it in 1:4){
    ...
    valid <- 4- aggr2_Label_switch_proxy_3st1p4_subs$no_chain[which(aggr2_Label_switch_proxy_3st1p4_subs$Group.4 == Convergence_gamma_3st_p4$n[ind] &
                                                                      aggr2_Label_switch_proxy_3st1p4_subs$Group.3 == Convergence_gamma_3st_p4$n_t[ind] &
                                                                      aggr2_Label_switch_proxy_3st1p4_subs$Group.2 == Convergence_gamma_3st_p4$n_dep[ind] &
                                                                      aggr2_Label_switch_proxy_3st1p4_subs$Group.1 == Convergence_gamma_3st_p4$KL_div[ind])]
    Convergence_gamma_3st_p4[ind: 
                               ((sim_it) * true_m * true_m + spacer), 10] <- valid
    
    sum_present <- aggr_Label_switch_proxy_3st1p4_subs$presentSUM[which(aggr_Label_switch_proxy_3st1p4_subs$sim_iteration == sim_it &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$n == Convergence_gamma_3st_p4$n[ind] &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$n_t == Convergence_gamma_3st_p4$n_t[ind] &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$n_dep == Convergence_gamma_3st_p4$n_dep[ind] &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$KL_div == Convergence_gamma_3st_p4$KL_div[ind])]
    if(sum_present == 0){
      Convergence_gamma_3st_p4[ind:
                                 ((sim_it) * true_m * true_m + spacer) ,9] <- Gelman_rubin_trans(data1 = gamma_full_conv0[[sc + l_files]][[sim_it]],  
                                                                                                 data2 = gamma_full_conv1[[sc + l_files]][[sim_it]],  
    ...
    #  if(aggr_Label_switch_proxy_3st1p4_subs$present0[which(aggr_Label_switch_proxy_3st1p4_subs$sim_iteration == sim_it &
    #                                                        aggr_Label_switch_proxy_3st1p4_subs$n == Convergence_gamma_3st_p4$n[ind] &
    #                                                        aggr_Label_switch_proxy_3st1p4_subs$n_t == Convergence_gamma_3st_p4$n_t[ind] &
    #                                                        aggr_Label_switch_proxy_3st1p4_subs$n_dep == Convergence_gamma_3st_p4$n_dep[ind] &
    #                                                        aggr_Label_switch_proxy_3st1p4_subs$KL_div == Convergence_gamma_3st_p4$KL_div[ind])] == 1){
    #    Convergence_gamma_3st_p4[ind:
    #                               ((sim_it) * true_m * true_m + spacer) ,9] <- Gelman_rubin_trans(data1 = NULL,  
    #                                                                                               data2 = gamma_full_conv1[[sc + l_files_p2]][[sim_it]],  
    #                                                                                               data3 = gamma_full_conv2[[sc + l_files_p2]][[sim_it]], 
    #                                                                                               m = true_m, 
    #                                                                                               J = J, 
    #                                                                                               burn_in = burn_in, 
    #                                                                                               n_chain = 2)
    #  } else if(aggr_Label_switch_proxy_3st1p4_subs$present1[which(aggr_Label_switch_proxy_3st1p4_subs$sim_iteration == sim_it &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$n == Convergence_gamma_3st_p4$n[ind] &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$n_t == Convergence_gamma_3st_p4$n_t[ind] &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$n_dep == Convergence_gamma_3st_p4$n_dep[ind] &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$KL_div == Convergence_gamma_3st_p4$KL_div[ind])] == 1){
    #    Convergence_gamma_3st_p4[ind:
    #                               ((sim_it) * true_m * true_m + spacer) ,9] <- Gelman_rubin_trans(data1 = gamma_full_conv0[[sc + l_files_p2]][[sim_it]],  
    #                                                                                               data2 = NULL,  
    #                                                                                               data3 = gamma_full_conv2[[sc + l_files_p2]][[sim_it]], 
    #                                                                                               m = true_m, 
    #                                                                                               J = J, 
    #                                                                                               burn_in = burn_in, 
    #                                                                                               n_chain = 2)
    #  } else if(aggr_Label_switch_proxy_3st1p4_subs$present2[which(aggr_Label_switch_proxy_3st1p4_subs$sim_iteration == sim_it &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$n == Convergence_gamma_3st_p4$n[ind] &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$n_t == Convergence_gamma_3st_p4$n_t[ind] &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$n_dep == Convergence_gamma_3st_p4$n_dep[ind] &
    #                                                               aggr_Label_switch_proxy_3st1p4_subs$KL_div == Convergence_gamma_3st_p4$KL_div[ind])] == 1){
...
View(Convergence_gamma_3st_p4)


### merging transition convergence results over partitions ####
Convergence_gamma_3st_corrected <- rbind(Convergence_gamma_3st_p1,
                               Convergence_gamma_3st_p2,
                               Convergence_gamma_3st_p4)

saveRDS(Convergence_gamma_3st_corrected, file = "result_tables/Convergence_gamma_3st_corrected_V2.RDS")


Convergence_gamma_3st_corrected$prop <- (Convergence_gamma_3st_corrected$GR_stat > 1.1) * 1
Convergence_gamma_3st_corrected$prop_conv <- (Convergence_gamma_3st_corrected$GR_stat < 1.1) * 1

sum(Convergence_gamma_3st_corrected$prop_conv, na.rm = TRUE) / sum(!is.na(Convergence_gamma_3st_corrected$prop_conv))
sum(Convergence_gamma_3st_corrected$prop_conv[Convergence_gamma_3st_corrected$KL_div==3], na.rm = TRUE) / sum(!is.na(Convergence_gamma_3st$prop_conv[Convergence_gamma_3st$KL_div==3]))
sum(Convergence_gamma_3st_corrected$prop_conv[Convergence_gamma_3st_corrected$KL_div==5], na.rm = TRUE) / sum(!is.na(Convergence_gamma_3st$prop_conv[Convergence_gamma_3st$KL_div==5]))
sum(Convergence_gamma_3st_corrected$prop_conv[Convergence_gamma_3st_corrected$KL_div==7], na.rm = TRUE) / sum(!is.na(Convergence_gamma_3st$prop_conv[Convergence_gamma_3st$KL_div==7]))

Subset_Convergence_gamma_3st_corrected <- Convergence_gamma_3st_corrected[Convergence_gamma_3st_corrected$KL_div > 3 &
                                                                            Convergence_gamma_3st_corrected$valid_runs > 2,]

sum(Subset_Convergence_gamma_3st_corrected$prop_conv, na.rm = TRUE) /sum(!is.na(Subset_Convergence_gamma_3st_corrected$prop_conv))
sum(Subset_Convergence_gamma_3st_corrected$prop_conv[Subset_Convergence_gamma_3st_corrected$KL_div==5], na.rm = TRUE) / sum(!is.na(Subset_Convergence_gamma_3st_corrected$prop_conv[Subset_Convergence_gamma_3st_corrected$KL_div==5]))
sum(Subset_Convergence_gamma_3st_corrected$prop_conv[Subset_Convergence_gamma_3st_corrected$KL_div==7], na.rm = TRUE) / sum(!is.na(Subset_Convergence_gamma_3st_corrected$prop_conv[Subset_Convergence_gamma_3st_corrected$KL_div==7]))



summary <- aggregate(Convergence_gamma_3st_corrected, by = list(Convergence_gamma_3st$n_dep, Convergence_gamma_3st$KL_div, Convergence_gamma_3st$n_t, Convergence_gamma_3st$n), FUN = mean, na.rm = TRUE)
View(summary)
...
summary_labelsw <- aggregate(Convergence_gamma_3st_corrected, by = list(Convergence_gamma_3st$n_dep, Convergence_gamma_3st$KL_div, Convergence_gamma_3st$n_t, Convergence_gamma_3st$n), FUN = sum_is.na)
...
# OLD, NOT CORRECTING FOR LABEL SWITCHING ####
sc <- 1
sim_it <- 1
n_sim <- 4
...
Convergence_emission_3st_p1 <- data.frame(sim_rep = rep(rep(1:n_sim, times = length(c(settings4[c(selected), 3]))), times = rep(c(settings4[c(selected), 3] * true_m), each = 4)),
                                       true_m = true_m,
...
Convergence_emission_3st_p2 <- data.frame(sim_rep = rep(rep(1:n_sim, times = length(c(settings4[c(selected_p2), 3]))), times = rep(c(settings4[c(selected_p2), 3] * true_m), each = 4)),
                                       true_m = true_m,
...
Convergence_emission_3st_p4 <- data.frame(sim_rep = rep(rep(1:n_sim, times = length(c(settings4[c(selected_p4), 3]))), times = rep(c(settings4[c(selected_p4), 3] * true_m), each = 4)),
                                       true_m = true_m,
...
for(sc in 1:length(selected)){
  for(sim_it in 1:4){
    ...
    sum_present <- aggr_Label_switch_proxy_3st1p1$presentSUM[which(aggr_Label_switch_proxy_3st1p1$sim_iteration == sim_it &
                                                                     aggr_Label_switch_proxy_3st1p1$n == Convergence_emission_3st_p1$n[ind] &
                                                                     aggr_Label_switch_proxy_3st1p1$n_t == Convergence_emission_3st_p1$n_t[ind] &
                                                                     aggr_Label_switch_proxy_3st1p1$n_dep == Convergence_emission_3st_p1$n_dep[ind] &
                                                                     aggr_Label_switch_proxy_3st1p1$KL_div == Convergence_emission_3st_p1$KL_div[ind])]
    
    valid <- 4- aggr2_Label_switch_proxy_3st1p1$no_chain[which(aggr2_Label_switch_proxy_3st1p1$Group.4 == Convergence_emission_3st_p1$n[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p1$Group.3 == Convergence_emission_3st_p1$n_t[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p1$Group.2 == Convergence_emission_3st_p1$n_dep[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p1$Group.1 == Convergence_emission_3st_p1$KL_div[ind])]
    Convergence_emission_3st_p1[ind: 
    ...
    #                                                   aggr_Label_switch_proxy_3st1p1$n_t == Convergence_emission_3st_p1$n_t[ind] &
    #                                                   aggr_Label_switch_proxy_3st1p1$n_dep == Convergence_emission_3st_p1$n_dep[ind] &
    #                                                   aggr_Label_switch_proxy_3st1p1$KL_div == Convergence_emission_3st_p1$KL_div[ind])] == 1){
    #    Convergence_emission_3st_p1[ind: 
    #                                  (cumsum_it[sc] + sim_it * spacer), 9] <- unlist(Gelman_rubin_emiss(data1 = NULL,  
    #                                                                                                     data2 = emiss_mean_full_conv1[[sc]][[sim_it]],  
    #                                                                                                     data3 = emiss_mean_full_conv2[[sc]][[sim_it]], 
    #                                                                                                     m = true_m, 
    #                                                                                                     J = J, 
...
# View(Convergence_emission_3st_p1)
...
for(sc in 1:length(selected_p2)){
  for(sim_it in 1:4){
    ...
    ind <- (1 + cumsum_it[sc] + (sim_it - 1) * spacer)
    sum_present <- aggr_Label_switch_proxy_3st1p2$presentSUM[which(aggr_Label_switch_proxy_3st1p2$sim_iteration == sim_it &
                                                                     aggr_Label_switch_proxy_3st1p2$n == Convergence_emission_3st_p2$n[ind] &
                                                                     aggr_Label_switch_proxy_3st1p2$n_t == Convergence_emission_3st_p2$n_t[ind] &
                                                                     aggr_Label_switch_proxy_3st1p2$n_dep == Convergence_emission_3st_p2$n_dep[ind] &
                                                                     aggr_Label_switch_proxy_3st1p2$KL_div == Convergence_emission_3st_p2$KL_div[ind])]
    valid <- 4- aggr2_Label_switch_proxy_3st1p2$no_chain[which(aggr2_Label_switch_proxy_3st1p2$Group.4 == Convergence_emission_3st_p2$n[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p2$Group.3 == Convergence_emission_3st_p2$n_t[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p2$Group.2 == Convergence_emission_3st_p2$n_dep[ind] &
                                                                 aggr2_Label_switch_proxy_3st1p2$Group.1 == Convergence_emission_3st_p2$KL_div[ind])]
    Convergence_emission_3st_p2[ind: 
                                  (cumsum_it[sc] + sim_it * spacer), 10] <- valid
    ...
    #                                                   aggr_Label_switch_proxy_3st1p2$n_t == Convergence_emission_3st_p2$n_t[ind] &
    #                                                   aggr_Label_switch_proxy_3st1p2$n_dep == Convergence_emission_3st_p2$n_dep[ind] &
    #                                                   aggr_Label_switch_proxy_3st1p2$KL_div == Convergence_emission_3st_p2$KL_div[ind])] == 1){
    #    Convergence_emission_3st_p2[ind: 
    #                                  (cumsum_it[sc] + sim_it * spacer), 9] <- unlist(Gelman_rubin_emiss(data1 = NULL,  
    #                                                                                                     data2 = emiss_mean_full_conv1[[sc + l_files]][[sim_it]],  
    #                                                                                                     data3 = emiss_mean_full_conv2[[sc + l_files]][[sim_it]], 
...
# View(Convergence_emission_3st_p2)
...
for(sc in 1:length(selected_p4)){
  for(sim_it in 1:4){
    ...
    ind <- (1 + cumsum_it[sc] + (sim_it - 1) * spacer)
    sum_present <- aggr_Label_switch_proxy_3st1p4_subs$presentSUM[which(aggr_Label_switch_proxy_3st1p4_subs$sim_iteration == sim_it &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$n == Convergence_emission_3st_p4$n[ind] &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$n_t == Convergence_emission_3st_p4$n_t[ind] &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$n_dep == Convergence_emission_3st_p4$n_dep[ind] &
                                                                          aggr_Label_switch_proxy_3st1p4_subs$KL_div == Convergence_emission_3st_p4$KL_div[ind])]
    valid <- 4- aggr2_Label_switch_proxy_3st1p4_subs$no_chain[which(aggr2_Label_switch_proxy_3st1p4_subs$Group.4 == Convergence_emission_3st_p4$n[ind] &
                                                                      aggr2_Label_switch_proxy_3st1p4_subs$Group.3 == Convergence_emission_3st_p4$n_t[ind] &
                                                                      aggr2_Label_switch_proxy_3st1p4_subs$Group.2 == Convergence_emission_3st_p4$n_dep[ind] &
                                                                      aggr2_Label_switch_proxy_3st1p4_subs$Group.1 == Convergence_emission_3st_p4$KL_div[ind])]
    Convergence_emission_3st_p4[ind: 
                                  (cumsum_it[sc] + sim_it * spacer), 10] <- valid
    if(sum_present == 0){
      Convergence_emission_3st_p4[ind: 
    ...
    #                                                        aggr_Label_switch_proxy_3st1p4_subs$n_t == Convergence_emission_3st_p4$n_t[ind] &
    #                                                        aggr_Label_switch_proxy_3st1p4_subs$n_dep == Convergence_emission_3st_p4$n_dep[ind] &
    #                                                        aggr_Label_switch_proxy_3st1p4_subs$KL_div == Convergence_emission_3st_p4$KL_div[ind])] == 1){
    #    Convergence_emission_3st_p4[ind: 
    #                                  (cumsum_it[sc] + sim_it * spacer), 9] <- unlist(Gelman_rubin_emiss(data1 = NULL,  
    #                                                                                                     data2 = emiss_mean_full_conv1[[sc + l_files_p2]][[sim_it]],  
    #                                                                                                     data3 = emiss_mean_full_conv2[[sc + l_files_p2]][[sim_it]], 
...
# View(Convergence_emission_3st_p4)

### merging transition convergence results over partitions ####
Convergence_emission_3st_corrected <- rbind(Convergence_emission_3st_p1,
                                            Convergence_emission_3st_p2,
                                         Convergence_emission_3st_p4)

saveRDS(Convergence_emission_3st_corrected, file = "result_tables/Convergence_emission_3st_corrected_V2.RDS")


Convergence_emission_3st_corrected$prop <- (Convergence_emission_3st_corrected$GR_stat > 1.1) * 1
Convergence_emission_3st_corrected$prop_conv <- (Convergence_emission_3st_corrected$GR_stat < 1.1) * 1

sum(Convergence_emission_3st_corrected$prop_conv, na.rm = TRUE) / sum(!is.na(Convergence_emission_3st_corrected$prop_conv))

sum(Convergence_emission_3st_corrected$prop_conv[Convergence_emission_3st_corrected$KL_div == 3], na.rm = TRUE) / sum(!is.na(Convergence_emission_3st_corrected$prop_conv[Convergence_emission_3st_corrected$KL_div == 3]))
sum(Convergence_emission_3st_corrected$prop_conv[Convergence_emission_3st_corrected$KL_div == 5], na.rm = TRUE) / sum(!is.na(Convergence_emission_3st_corrected$prop_conv[Convergence_emission_3st_corrected$KL_div == 5]))
sum(Convergence_emission_3st_corrected$prop_conv[Convergence_emission_3st_corrected$KL_div == 7], na.rm = TRUE) / sum(!is.na(Convergence_emission_3st_corrected$prop_conv[Convergence_emission_3st_corrected$KL_div == 7]))


Subset_Convergence_emission_3st_corrected <- Convergence_emission_3st_corrected[Convergence_emission_3st_corrected$KL_div > 3 &
                                                                                  Convergence_emission_3st_corrected$valid_runs > 2,]

sum(Subset_Convergence_emission_3st_corrected$prop_conv, na.rm = TRUE) /sum(!is.na(Subset_Convergence_emission_3st_corrected$prop_conv))
sum(Subset_Convergence_emission_3st_corrected$prop_conv[Subset_Convergence_emission_3st_corrected$KL_div==5], na.rm = TRUE) / sum(!is.na(Subset_Convergence_emission_3st_corrected$prop_conv[Subset_Convergence_emission_3st_corrected$KL_div==5]))
sum(Subset_Convergence_emission_3st_corrected$prop_conv[Subset_Convergence_emission_3st_corrected$KL_div==7], na.rm = TRUE) / sum(!is.na(Subset_Convergence_emission_3st_corrected$prop_conv[Subset_Convergence_emission_3st_corrected$KL_div==7]))



summary_emiss <- aggregate(Convergence_emission_3st_corrected, by = list(Convergence_emission_3st_corrected$n_dep, 
                                                                         Convergence_emission_3st_corrected$KL_div, 
                                                                         Convergence_emission_3st_corrected$n_t, 
                                                                         Convergence_emission_3st_corrected$n), FUN = mean, na.rm = TRUE)

summary_emiss_prop_conv <- aggregate(Convergence_emission_3st_corrected, by = list(Convergence_emission_3st_corrected$n_dep, 
                                                                         Convergence_emission_3st_corrected$KL_div, 
                                                                         Convergence_emission_3st_corrected$n_t, 
                                                                         Convergence_emission_3st_corrected$n), FUN = sum_is.na)
